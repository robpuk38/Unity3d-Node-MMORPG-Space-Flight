...
public class VirtualButtonPressA : MonoBehaviour, IPointerUpHandler, IPointerDownHandler
{
    ...
    private void Update()
    {
        if (player != null)
        {
            ...
            bgImg = player.transform.GetChild(1).GetChild(0).GetChild(3).gameObject.GetComponent<Image>();
            joystickImg = player.transform.GetChild(1).GetChild(0).GetChild(3).GetChild(0).gameObject.GetComponent<Image>();
    ...
    public virtual void OnPointerDown(PointerEventData ped)
    {
       ...
       // Debug.Log("WE HAVE PRESSSED THE A BUTTON");
